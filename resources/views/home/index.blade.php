    ...
    <div class="bg-base-1">
        <div class="container py-5 py-md-7">
            <div class="text-center">
                <h2 class="h2 mb-3 font-weight-bold text-center">{{ __('Features') }}</h2>
                <div class="mx-auto mb-5">
                    <p class="text-muted font-weight-normal font-size-lg mb-0">{{ __('Enhance your links with advanced customizations and detailed statistics.') }}</p>
                </div>
            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            <div class="d-flex width-8 height-8 position-relative align-items-center justify-content-center flex-shrink-0 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Custom aliases') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Branded domains') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Statistics') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Retargeting pixels') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Traffic splitting') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Password protection') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Country targeting') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Platform targeting') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Language targeting') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('UTM builder') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('Expiration dates') }}</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4 p-2 p-sm-3">
                    <div class="card border-0 shadow-sm h-100 border-radius-xl">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-block w-100"><div class="d-inline-block font-weight-bold">{{ __('QR codes') }}</div></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-6 px-5">
                    <div class="row">
                        <div class="col-12 text-center {{ (__('lang_dir') == 'rtl' ? 'text-lg-right' : 'text-lg-left') }}">
                            <h2 class="h2 mb-3 font-weight-bold">{{ __('Link management') }}</h2>
                            <div class="m-auto">
        ...
        <div class="container py-5 py-md-7 position-relative z-1">
            <div class="row mx-n5">
                <div class="col-12 col-lg-6 px-5 order-1 order-lg-2">
                    <div class="row">
                        <div class="col-12 text-center {{ (__('lang_dir') == 'rtl' ? 'text-lg-right' : 'text-lg-left') }}">
                            <h2 class="h2 mb-3 font-weight-bold">{{ __('Statistics') }}</h2>
                        ...
                        <div class="col-12 col-sm-6 mt-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="d-block w-100"><div class="d-inline-block font-weight-bold font-size-lg">{{ __('Overview') }}</div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mt-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="d-block w-100"><div class="d-inline-block font-weight-bold font-size-lg">{{ __('Referrers') }}</div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mt-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="d-block w-100"><div class="d-inline-block font-weight-bold font-size-lg">{{ __('Countries') }}</div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mt-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="d-block w-100"><div class="d-inline-block font-weight-bold font-size-lg">{{ __('Cities') }}</div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mt-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="d-block w-100"><div class="d-inline-block font-weight-bold font-size-lg">{{ __('Languages') }}</div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mt-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="d-block w-100"><div class="d-inline-block font-weight-bold font-size-lg">{{ __('Platforms') }}</div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mt-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="d-block w-100"><div class="d-inline-block font-weight-bold font-size-lg">{{ __('Browsers') }}</div></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mt-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="d-block w-100"><div class="d-inline-block font-weight-bold font-size-lg">{{ __('Devices') }}</div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <div class="d-flex justify-content-between mb-2">
                                                            <div class="d-flex text-truncate align-items-center">
                                                                <div class="d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}"><img src="{{ asset('img/icons/countries/us.svg') }}" class="width-4 height-4" alt="{{ __('United States') }}"></div>
                                                                <div class="text-truncate">
                                                                    United States
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="list-group list-group-flush my-n3">
                                                <div class="list-group-item px-0 border-0">
                                                    <div class="d-flex flex-column">
                                                        <div class="d-flex justify-content-between mb-2">
                                                            <div class="d-flex text-truncate align-items-center">
                                                                <div class="d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}"><img src="{{ asset('img/icons/os/windows.svg') }}" class="width-4 height-4" alt="Windows"></div>
                                                                <div class="text-truncate">
                                                                    Windows
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="list-group list-group-flush my-n3">
                                                <div class="list-group-item px-0 border-0">
                                                    <div class="d-flex flex-column">
                                                        <div class="d-flex justify-content-between mb-2">
                                                            <div class="d-flex text-truncate align-items-center">
                                                                <div class="d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}"><img src="{{ asset('img/icons/browsers/chrome.svg') }}" class="width-4 height-4" alt="Chrome"></div>
                                                                <div class="text-truncate">
                                                                    Chrome
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="list-group list-group-flush my-n3">
                                                <div class="list-group-item px-0 border-0">
                                                    <div class="d-flex flex-column">
                                                        <div class="d-flex justify-content-between mb-2">
                                                            <div class="d-flex text-truncate align-items-center">
                                                                <div class="d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}"><img src="{{ asset('img/icons/devices/desktop.svg') }}" class="width-4 height-4" alt="{{ __('Desktop') }}"></div>
                                                                <div class="text-truncate">
                                                                    Desktop
                                                                </div>
                                                            </div>
        ...
        <div class="container position-relative text-center py-5 py-md-7 d-flex flex-column z-1">
            ...
            <div class="d-flex flex-wrap justify-content-center justify-content-lg-between mt-4 mx-n3">
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="Google Ads">
                    <img src="{{ asset('img/icons/pixels/' . md5('google-ads')) }}.svg" class="width-8 height-8" alt="Google Ads">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="Google Analytics">
                    <img src="{{ asset('img/icons/pixels/' . md5('google-analytics')) }}.svg" class="width-8 height-8" alt="Google Analytics">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="Google Tag Manager">
                    <img src="{{ asset('img/icons/pixels/' . md5('google-tag-manager')) }}.svg" class="width-8 height-8" alt="Google Tag Manager">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="Facebook">
                    <img src="{{ asset('img/icons/pixels/' . md5('facebook')) }}.svg" class="width-8 height-8" alt="Facebook">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="Bing">
                    <img src="{{ asset('img/icons/pixels/' . md5('bing')) }}.svg" class="width-8 height-8" alt="Bing">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="X">
                    <img src="{{ asset('img/icons/pixels/' . md5('x')) }}.svg" class="width-8 height-8" alt="X">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="Pinterest">
                    <img src="{{ asset('img/icons/pixels/' . md5('pinterest')) }}.svg" class="width-8 height-8" alt="Pinterest">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="LinkedIn">
                    <img src="{{ asset('img/icons/pixels/' . md5('linkedin')) }}.svg" class="width-8 height-8" alt="LinkedIn">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="Quora">
                    <img src="{{ asset('img/icons/pixels/' . md5('quora')) }}.svg" class="width-8 height-8" alt="Quora">
                </div>
                ...
                <div class="bg-base-1 d-flex width-20 height-20 position-relative align-items-center justify-content-center flex-shrink-0 border-radius-3xl mx-3 mt-3" data-tooltip="true" title="Adroll">
                    <img src="{{ asset('img/icons/pixels/' . md5('adroll')) }}.svg" class="width-8 height-8" alt="Adroll">
                </div>
            </div>
        </div>
    </div>
