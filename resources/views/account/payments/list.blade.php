                            ...
                            <div class="col text-truncate">
                                <div class="row align-items-center text-truncate">
                                    ...
                                    <div class="d-none d-lg-block col-lg-2 text-truncate">
                                        <span class="text-truncate" data-tooltip="true" title="{{ $payment->created_at->tz(Auth::user()->timezone ?? config('settings.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $payment->created_at->diffForHumans() }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
