...
<div class="bg-base-1 flex-fill">
    <div class="container py-6">
        <div class="text-center">
            ...
            <div class="m-auto">
                <p class="text-muted font-weight-normal font-size-lg mb-0">{{ __('Updated at') }}: {{ $page->updated_at->tz(Auth::user()->timezone ?? config('settings.timezone'))->format(__('Y-m-d')) }}.</p>
            </div>
        </div>
