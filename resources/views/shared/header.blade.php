                ...
                <div class="row no-gutters">
                    <div class="col">
                        <div class="small text-muted">
                            {{ __(':number of :total links used.', ['number' => shortenNumber($linksCount), 'total' => (Auth::user()->active_plan->features->links < 0 ? '∞' : shortenNumber(Auth::user()->active_plan->features->links))]) }}
                        </div>
                    </div>
                </div>

                <div class="progress w-100 my-2 height-1.25">
                    <div class="progress-bar rounded" role="progressbar" style="width: {{ (Auth::user()->active_plan->features->links == 0 ? 100 : (($linksCount / Auth::user()->active_plan->features->links) * 100)) }}%"></div>
                </div>
            </a>
