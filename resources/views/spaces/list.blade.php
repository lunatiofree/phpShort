                                ...
                                <div class="row align-items-center">
                                    <div class="col text-truncate">
                                        <div class="row align-items-center">
                                                ...
                                                <div class="text-truncate">
                                                    <div class="d-flex">
                                                        <div class="d-flex align-items-center text-truncate">
                                                            ...
                                                            <div class="text-truncate"><a href="{{ route('links', ['space_id' => $space->id]) }}">{{ $space->name }}</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-none d-lg-block col-lg-2">
                                                <a href="{{ route('links', ['space_id' => $space->id]) }}" class="text-dark">{{ $space->totalLinks }}</a>
                                            </div>

                                            <div class="d-none d-lg-block col-lg-2 text-truncate">
                                                <span class="text-truncate" data-tooltip="true" title="{{ $space->created_at->tz(Auth::user()->timezone ?? config('settings.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $space->created_at->diffForHumans() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
