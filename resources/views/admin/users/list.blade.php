                                    ...
                                    <div class="dropdown-menu {{ (__('lang_dir') == 'rtl' ? 'dropdown-menu' : 'dropdown-menu-right') }} border-0 shadow width-64 p-0" id="search-filters">
                                        ...
                                        <div class="max-height-96 overflow-auto pt-3">
                                            ...
                                            <div class="form-group px-4">
                                                ...
                                                <select id="i-plan-id" name="plan_id" class="custom-select custom-select-sm">
                ...
                @foreach($users as $user)
                    <div class="list-group-item px-0">
                        <div class="row">
                            <div class="d-none col-auto align-items-center" data-bulk-checkbox-column>
                                <div class="custom-control custom-checkbox" data-bulk-check>
                                    <input type="checkbox" class="custom-control-input" id="bulk-check-{{ $user->id }}" name="bulk[]" value="{{ $user->id }}" data-bulk-checkbox @if(Auth::user()->id == $user->id && $user->role == 1) disabled @endif>
                                        ...
                                        <div class="row text-truncate">
                                            <div class="col-12 col-lg-5 d-flex align-items-center text-truncate">
                                                <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                                    <img src="{{ $user->avatarUrl }}" class="rounded-circle width-6 height-6">
                                                </div>
