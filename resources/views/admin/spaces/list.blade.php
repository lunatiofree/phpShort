                                    ...
                                    <div class="dropdown-menu {{ (__('lang_dir') == 'rtl' ? 'dropdown-menu' : 'dropdown-menu-right') }} border-0 shadow width-64 p-0" id="search-filters">
                                        <div class="dropdown-header py-3">
                                            <div class="row">
                                                ...
                                                <div class="col-auto"><a href="{{ route('admin.spaces') }}" class="text-secondary">{{ __('Reset') }}</a></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="max-height-96 overflow-auto pt-3">
                                            ...
                                            <div class="form-group px-4">
                                                <div class="text-truncate d-block">
                                                    ...
                                                    @if ($link) <a href="{{ route('admin.links.edit', ['id' => $link->id]) }}" class="small text-truncate">{{ $link->displayShortUrl }}</a> @endif
                                                </div>
                ...
                @foreach($spaces as $space)
                    <div class="list-group-item px-0">
                        <div class="row">
                            <div class="d-none col-auto align-items-center" data-bulk-checkbox-column>
                                <div class="custom-control custom-checkbox" data-bulk-check>
                                    <input type="checkbox" class="custom-control-input" id="bulk-check-{{ $space->id }}" name="bulk[]" value="{{ $space->id }}" data-bulk-checkbox>
                                    <label class="custom-control-label user-select-none" for="bulk-check-{{ $space->id }}"></label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="row align-items-center">
                                        ...
                                        <div class="row align-items-center">
                                                ...
                                                <div class="text-truncate">
                                                    <div class="d-flex">
                                                        <div class="d-flex align-items-center text-truncate">
                                                            ...
                                                            <div class="text-truncate"><a href="{{ route('admin.spaces.edit', ['id' => $space->id]) }}">{{ $space->name }}</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-lg-5 d-flex align-items-center">
                                                <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                                    <img src="{{ $space->user->avatarUrl }}" class="rounded-circle width-6 height-6">
                                                </div>
                                                <a href="{{ route('admin.users.edit', $space->user->id) }}">{{ $space->user->name }}</a>
                                            </div>
