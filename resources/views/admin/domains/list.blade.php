                                    ...
                                    <div class="dropdown-menu {{ (__('lang_dir') == 'rtl' ? 'dropdown-menu' : 'dropdown-menu-right') }} border-0 shadow width-64 p-0" id="search-filters">
                                        <div class="dropdown-header py-3">
                                            <div class="row">
                                                ...
                                                <div class="col-auto"><a href="{{ route('admin.domains') }}" class="text-secondary">{{ __('Reset') }}</a></div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="text-truncate">
                                                    <div class="d-flex">
                                                        <div class="d-flex align-items-center text-truncate">
                                                            <img src="{{ favicon($domain->name) }}" rel="noreferrer" class="width-4 height-4 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                            ...
                                            <div class="col-12 col-lg-5 d-flex align-items-center">
                                                @if(isset($domain->user))
                                                    <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                                        <img src="{{ (isset($domain->user) ? $domain->user->avatarUrl : asset('img/user.png')) }}" class="rounded-circle width-6 height-6">
                                                    </div>
