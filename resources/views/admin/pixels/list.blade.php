                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-lg-5 d-flex align-items-center">
                                                <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                                    <img src="{{ $pixel->user->avatarUrl }}" class="rounded-circle width-6 height-6">
                                                </div>
                                                <a href="{{ route('admin.users.edit', $pixel->user->id) }}">{{ $pixel->user->name }}</a>
                                            </div>
        
                                            <div class="col-12 col-lg-2 d-flex">
                                                <a href="{{ route('admin.links', ['pixel_id' => $pixel->id]) }}" class="text-dark">{{ $pixel->totalLinks }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
