...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <ul class="nav nav-pills d-flex flex-fill flex-column flex-lg-row mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item flex-grow-1 text-center">
                <a class="nav-link" id="pills-paddle-tab" data-toggle="pill" href="#pills-paddle" role="tab" aria-controls="pills-paddle" aria-selected="false">{{ __('Paddle') }}</a>
            </li>
        ...
        <form action="{{ route('admin.settings', 'payment-processors') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-paddle" role="tabpanel" aria-labelledby="pills-paddle-tab">
                    <div class="form-group">
                        <label for="i-paddle">{{ __('Enabled') }}</label>
