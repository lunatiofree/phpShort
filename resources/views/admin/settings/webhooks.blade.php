...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <ul class="nav nav-pills d-flex flex-fill flex-column flex-md-row mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item flex-grow-1 text-center">
                <a class="nav-link" id="pills-domain-tab" data-toggle="pill" href="#pills-domain" role="tab" aria-controls="pills-domain" aria-selected="false">{{ __('Domain') }}</a>
            </li>
        </ul>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                    <div class="form-group">
                        ...
                        @endif
                        <small class="form-text text-muted">{!! __(':fields fields are being sent when a user is created.', ['fields' => '<code class="badge badge-secondary">' . implode('</code>, <code class="badge badge-secondary">', ['id', 'name', 'email', 'email_verified_at', 'action']) . '</code>']) !!}</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @endif
                        <small class="form-text text-muted">{!! __(':fields fields are being sent when a user is updated.', ['fields' => '<code class="badge badge-secondary">' . implode('</code>, <code class="badge badge-secondary">', ['id', 'name', 'email', 'email_verified_at', 'action']) . '</code>']) !!}</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @endif
                        <small class="form-text text-muted">{!! __(':fields fields are being sent when a user is deleted.', ['fields' => '<code class="badge badge-secondary">' . implode('</code>, <code class="badge badge-secondary">', ['id', 'name', 'email', 'email_verified_at', 'action']) . '</code>']) !!}</small>
                    </div>
                </div>
                
                <div class="tab-pane fade" id="pills-domain" role="tabpanel" aria-labelledby="pills-domain-tab">
                    <div class="form-group">
                        <label for="i-webhook-domain-created" class="d-inline-flex align-items-center"><span class="badge badge-warning">{{ __('Store') }}</span></label>
