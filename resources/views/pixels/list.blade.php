...
<div class="d-flex">
    <div class="flex-grow-1">
        <h1 class="h2 mb-3 d-inline-block">{{ __('Pixels') }}</h1>
    </div>
    <div>
                                    ...
                                    <div class="dropdown-menu {{ (__('lang_dir') == 'rtl' ? 'dropdown-menu' : 'dropdown-menu-right') }} border-0 shadow width-64 p-0" id="search-filters">
                                        <div class="dropdown-header py-3">
                                            <div class="row">
                                                ...
                                                <div class="col-auto"><a href="{{ route('pixels') }}" class="text-secondary">{{ __('Reset') }}</a> </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col text-truncate">
                                        <div class="row align-items-center">
                                                ...
                                                <div class="text-truncate">
                                                    <div class="d-flex">
                                                        <div class="d-flex align-items-center text-truncate">
                                                            <img src="{{ asset('img/icons/pixels/' . md5(strtolower($pixel->type))) }}.svg" rel="noreferrer" class="width-4 height-4 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                                            <div class="text-truncate"><a href="{{ route('links', ['pixel_id' => $pixel->id]) }}">{{ $pixel->name }}</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-none d-lg-block col-lg-2">
                                                <a href="{{ route('links', ['pixel_id' => $pixel->id]) }}" class="text-dark">{{ $pixel->totalLinks }}</a>
                                            </div>

                                            <div class="d-none d-lg-block col-lg-2 text-truncate">
                                                <span class="text-truncate" data-tooltip="true" title="{{ $pixel->created_at->tz(Auth::user()->timezone ?? config('settings.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $pixel->created_at->diffForHumans() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
